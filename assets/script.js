...
const helpContent = {
	shellType: {
		header: 'Shell Type',
		body: 'Loại pháo hoa sẽ được bắn. Chọn "Ngẫu nhiên" để có một loại tốt đẹp!'
	},
	shellSize: {
		header: 'Shell Size',
		body: 'Kích thước của pháo hoa. Mô phỏng theo kích thước thực của các quả pháo hoa, các quả lớn có phát nổ lớn với nhiều ngôi sao hơn, và đôi khi có hiệu ứng phức tạp hơn. Tuy nhiên, các quả lớn cũng đòi hỏi nhiều công suất xử lý hơn và có thể gây trễ hình ảnh.'
	},
	quality: {
		header: 'Quality',
		body: 'Chất lượng đồ họa tổng thể. Nếu hoạt ảnh không chạy mượt, hãy thử giảm chất lượng. Chất lượng cao tăng đáng kể số lượng tia lửa được hiển thị và có thể gây trễ hình ảnh.'
	},
	skyLighting: {
		header: 'Sky Lighting',
		body: 'Chiếu sáng nền khi pháo hoa nổ. Nếu nền trông quá sáng trên màn hình của bạn, hãy thử đặt nó ở chế độ "Mờ" hoặc "Không có".'
	},
	scaleFactor: {
		header: 'Scale',
		body: 'Cho phép thay đổi tỷ lệ của tất cả pháo hoa, thay đổi khoảng cách xa hay gần hơn. Đối với các kích thước pháo lớn, có thể thuận tiện để giảm tỷ lệ một chút, đặc biệt trên điện thoại hoặc máy tính bảng.'
	},
	autoLaunch: {
		header: 'Auto Fire',
		body: 'Tự động kích hoạt chuỗi pháo hoa một cách tự động. Ngồi lại và thưởng thức màn trình diễn, hoặc tắt để có quyền kiểm soát đầy đủ.'
	},
	finaleMode: {
		header: 'Finale Mode',
		body: 'Phát nổ cực kỳ mạnh mẽ của pháo hoa. Có thể gây trễ hình ảnh. Yêu cầu "Tự Động Bắn" được kích hoạt.'
	},
	hideControls: {
		header: 'Hide Controls',
		body: 'Ẩn bảng điều khiển trong suốt ở phía trên màn hình. Hữu ích cho việc chụp ảnh màn hình hoặc để có trải nghiệm liền mạch hơn. Khi ẩn, bạn vẫn có thể chạm vào góc phải phía trên để mở lại menu này.'
	},
	fullscreen: {
		header: 'Fullscreen',
	...
	longExposure: {
		header: 'Open Shutter',
		body: 'Hiệu ứng thử nghiệm giữ các vệt sáng dài, tương tự như việc để mở ống kính máy ảnh.'
	}
};
